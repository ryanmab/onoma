...
/// -1.5% penalty for symbols defined in TypeScript (or TSX) which are constants that are
/// camel case.
///
...
///
/// There are exceptions to this - for example, React hooks (i.e. `const useSomething = () => {}`),
/// so the penalty shouldn't be too high.
///
/// TODO: Can we make this more intelligent to factor in the _value_ of the const, or the AST
/// hierarchy? I.e. No penalty for camel case arrow functions (like React hooks), or constants
/// defined at the top of a file (not in a function)?
///
/// See: <https://www.w3schools.com/js/js_const.asp>
pub const JS_TS_CAMEL_CASE_CONSTANT_PENALTY: i64 = -((constant::DEFAULT_SCORE * 15) / 1000);
...
mod tests {
    ...
    #[rstest]
    #[case("x", SymbolKind::Constant, Language::TypeScript, -15)]
    #[case("someVar", SymbolKind::Constant, Language::TypeScript, -15)]
    ...
    #[case("batter", SymbolKind::Constant, Language::Javascript, -15)]
    #[case("latte", SymbolKind::Constant, Language::JavascriptJsx, -15)]
