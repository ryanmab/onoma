...
pub fn calculate_score(
    query: &str,
    symbol: &models::resolved::ResolvedSymbol,
    fuzzy_matches: impl Iterator<Item = frizbee::Match>,
...
mod tests {
    ...
    pub fn test_scoring_struct_in_entrypoint_file() {
        ...
        let score = super::calculate_score("", &symbol, Vec::new().into_iter(), None);
    ...
    pub fn test_scoring_type_in_autogenerated_folder() {
        ...
        target_score += 35; // Increase the score by 3.5%, because it is a Class
        target_score -= 2; // Decrease the score by 0.25%, because it's an entrypoint file
        target_score -= 50; // Decrease the score by 7%, because its in an autogenerated folder
    ...
    pub fn test_scoring_fuzzy_matched_symbol() {
        ...
        let score = super::calculate_score(query, &symbol, fuzzy_matches.into_iter(), None);
